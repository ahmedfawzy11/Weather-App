...
class SunsetSunriseByCitySearch extends StatelessWidget {
  const SunsetSunriseByCitySearch({
    Key? key,
  }) : super(
          key: key,
        );
                          ...
                          Text(
                            DateFormat(
                              ...
                              DateTime.fromMillisecondsSinceEpoch(
                                state.currentWeatherByCity!.sunrise.toInt() *
                                    1000,
                              ),
                            ),
                            style: TextStyle(
                        ...
                        children: [
                          ...
                          Text(
                            DateFormat(
                              ...
                              DateTime.fromMillisecondsSinceEpoch(
                                state.currentWeatherByCity!.sunset.toInt() *
                                    1000,
                              ),
                            ),
                            style: TextStyle(
