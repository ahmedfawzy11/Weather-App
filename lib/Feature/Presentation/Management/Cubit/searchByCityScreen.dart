...
import 'package:weather_application/Feature/Presentation/Management/Cubit/cubit.dart';
                        ...
                        child: Column(
                          children: [
                            ...
                            LottieBuilder.asset(
                              "${DateFormat(' a').format(
                                    DateTime.now(),
                                  ) == "AM" ? ImageAsset.evening : ImageAsset.morning}",
